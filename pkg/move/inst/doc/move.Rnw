...
Running the \fct{brownian.bridge.dyn} creates an object of the \class{DBBMM} class, which amonge others stores the raster of the map with the values from the UD. 
