...
Bursted tracks can be plotted with \fct{plotBursts}. The function plots different colored 
%%marco plotBursts does not work!!
...
plot(ricky_dbbmm, xlab="location_long", ylab="location_lat")
lines(spTransform(ricky, center=TRUE), col=3, lwd=2)
plot(ricky_dbbmm, xlab="location_long", ylab="location_lat")
points(spTransform(ricky, center=TRUE), col=8)
@
\end{center}
