...
test_that('timestamps order ing in stack',{
  ...
  t<-as.POSIXct(rep(1,3), origin='1970-1-1')
  u@timestampsUnUsedRecords<-t
  expect_error(validObject(u),"The data set includes double timestamps per ID in the unused records \\(first one:a 1 1970-01-01 01:00:01\\)")
